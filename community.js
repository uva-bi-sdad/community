          ...
          init: function (o) {
            if (site.text && Object.hasOwn(site.text, o.id)) {
              ...
              for (i = o.condition.length; i--; )
                if (Object.hasOwn(_u, o.condition[i].id))
                  add_dependency(o.condition[i].id, { type: "display", id: o.id })
          ...
          init: function (o) {
            if (Object.hasOwn(site.plots, o.id)) {
              ...
              for (i = site.plots[o.id].data.length; i--; ) {
                ...
                if (!Object.hasOwn(p.marker.line, "color")) p.marker.line.color = "#808080"
          ...
          init: function (o) {
            ...
            if (o.options.single_variable) {
              ...
              for (i = o.options.variables.length; i--; ) {
                if ("string" === typeof o.options.variables[i])
                  o.options.variables[i] = { name: o.options.variables[i] }
        ...
        for (y = 0; y < ny; y++) {
          if (levels) {
            ...
            if (ms.n[y]) {
              ...
              ms.median[y] = ms.mean[y]
              ms.q3[y] = ms.median[y] ? (ms.max[y] + ms.median[y]) / 2 : ms.mean[y]
              ms.q1[y] = ms.median[y] ? (ms.min[y] + ms.median[y]) / 2 : ms.mean[y]
            } else {
              ms.max[y] = 0
              ms.q3[y] = 0
              ms.median[y] = 0
