void (function () {
  ...
  document.onreadystatechange = function () {
    ...
    document.body.className =
      'true' === storage.getItem('theme_dark') || site.settings.theme_dark ? 'dark-theme' : 'light-theme'
  ...
  function compile_dataview(v) {
    ...
    v.get = {
      dataset: function () {
        return (
          valueOf('string' === typeof v.dataset && Object.hasOwn(_u, v.dataset) ? _u[v.dataset].value() : v.dataset) ||
          defaults.dataset
        )
      },
      ids: function () {
